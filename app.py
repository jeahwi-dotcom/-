...
st.subheader("S&P 500 시장 지표 및 종목별 하이퍼 매트릭스")
...
if data:
    # --- [섹션 1] S&P 500 시장 종합 지표 (복구된 부분) ---
    st.markdown("### 🏛️ 미국 시장 종합 지표 (S&P 500)")
